      ...
      <div className="flex items-center justify-between h-[48px]  px-2 py-1.5 flex-shrink-0">
        <div className="flex items-center gap-2 flex-shrink-0">
          <div className="flex items-center justify-center">
            <button className="text-sm p-2 flex place-items-end gap-1 cursor-pointer items-center" onClick={() => {
          ...
          <div className="flex items-center gap-1 ">
            <button className="flex items-center py-2 pl-2 pr-3 gap-1 text-sm cursor-pointer" onClick={() => {
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button className="flex items-center py-[7px] pl-2 pr-3 border border-border-gray rounded-md text-sm gap-1 box-border cursor-pointer" onClick={() => {
          ...
          <button className="flex items-center py-2 px-6 bg-green-800 text-white rounded-md text-sm gap-1 font-medium box-border cursor-pointer" onClick={() => {
